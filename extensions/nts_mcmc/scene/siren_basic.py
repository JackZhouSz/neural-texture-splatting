...
class SirenNet(nn.Module):
    ...
    def __init__(self, in_channels=4, out_channels=16, D=4, W=128, skips=[], init_siren_frequency=10):
        ...
        first_omega_0 = init_siren_frequency
        # first_omega_0 = 1
        hidden_omega_0 = 1.0
        # hidden_omega_0 = 5.0
    ...
    def forward(self, x, t=None):
        ...
        for i, layer in enumerate(self.linears):
            if i in self.skips:
                feature_next = torch.cat([x, layer(feature)], dim=-1)
            else:
