...
class ModelHiddenParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.renderer_3dgs = False # if true, use modified 3dgs baseline, else use the GoF rasterizer
        self.cp_decomposition = False
        self.compression = 'vm'
        # self.mode = 'lookup'
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.densify_until_iter = 100000
        ...
        self.lambda_distortion = 1
        self.lambda_depth_normal = 0.001
        self.distortion_from_iter = 10000
        self.depth_normal_from_iter = 10000
